...
form.addEventListener('submit', e => {
    ...
    axios.post('http://localhost:8000/expense/addexpense', expenseDetails, {headers: {"Authorization": token}})
    .then(res => {
        getExpenses()
    })
    .catch(err => {
...
function getExpenses(){
    const token = localStorage.getItem('token')
    axios.get('http://localhost:8000/expense/allexpense', {headers: {"Authorization": token}})
    .then(res => {
...
function delExpense(e) {
    ...
    axios.post('http://localhost:8000/expense/delete/', { id }, {headers: {"Authorization": token}})
    .then(_ => {
...
document.getElementById('rzp-button1').onclick = function(e) {
    ...
    axios.get('http://localhost:8000/purchase/premium-membership', {headers: {"Authorization": token}})
    .then(res => {
        res = res.data
        ...
        let options = {
            ...
            "handler": function(response) {
                axios.post('http://localhost:8000/purchase/update-transaction-status', {
...
function premiumUser() {
    ...
    axios.get('http://localhost:8000/purchase/is-premium', {headers: {"Authorization": token}}) 
    .then(res => {
